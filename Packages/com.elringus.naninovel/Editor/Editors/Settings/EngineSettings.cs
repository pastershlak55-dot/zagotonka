...
namespace Naninovel
{
    public class EngineSettings : ConfigurationSettings<EngineConfiguration>
    {
        ...
        protected override Dictionary<string, Action<SerializedProperty>> OverrideConfigurationDrawers ()
        {
            ...
            drawers[nameof(EngineConfiguration.GeneratedDataPath)] = p => EditorUtils.FolderField(p, transformPath: p => p.GetAfter("Assets/"));
            ...
            drawers[nameof(EngineConfiguration.NaninovelProjectRoot)] = p => DrawWhen(jsonAvailable && Configuration.EnableBridging, () => EditorUtils.FolderField(p));
