...
namespace Naninovel
{
    ...
    public class EngineConfiguration : Configuration
    {
        ...
        [Tooltip("Root directory of the Naninovel project, relative to the Unity project root. By default, equals the Unity project root (empty value).\n\n" +
                 "Naninovel will generate a `.nani` folder under the selected root, where it'll store generated project metadata and communicate with the authoring tools via file-based IPC.")]
        public string NaninovelProjectRoot = "";
